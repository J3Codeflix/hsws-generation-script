module.exports = [
  ...
  },
  {
    ...
    count: 22,
    offset: {x: -1080, y: 0},
    attrNames:['angry','bored 1','bored 2','closed','focused','sad','skeptical','surprised','tired','wink','black posh sunglasses','black tinted sunglasses','classic sunglasses',
      'futuristic glasses','stacked sunglasses','white chunky sunglasses','white posh sunglasses','white tinted sunglasses','yellow chunky sunglasses'],
    required: true,
  },
  {
    name: 'mouth/Mouth',
